...
public class UpdateCswConfiguration extends BaseFunctionField<BooleanField> {
  ...
  public BooleanField performFunction() {
    ...
    configurator.add(configuratorSuite.getFeatureActions().start(CSW_FEATURE));
    ...
    addMessages(serviceCommons.updateService(config.pidField(), cswConfigToServiceProps(config)));
