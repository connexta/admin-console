...
public abstract class BaseEnumField<S> extends BaseField<S> implements EnumField<S, EnumValue<S>> {
  ...
  public BaseEnumField(
      String fieldName, String fieldTypeName, String description, List<EnumValue<S>> enumValues) {
          ...
          getEnumValues()
              ...
              .filter(
                  o ->
                      o.equals(value)
                          || (o instanceof String
                              && o.toString().equalsIgnoreCase(value.toString())))
              .findFirst()
              .orElse(value);
    }
  }
