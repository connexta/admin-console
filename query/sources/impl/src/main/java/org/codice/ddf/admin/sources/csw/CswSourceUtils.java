...
public class CswSourceUtils {
   ...
   * @return a {@link ReportWithResultImpl} containing the {@link CswSourceConfigurationField} or an
   *     {@link org.codice.ddf.admin.api.report.ErrorMessage} on failure.
   */
  public ReportWithResult<CswSourceConfigurationField> getConfigFromHost(
    ...
    PrioritizedBatchExecutor<
            ReportWithResultImpl<CswSourceConfigurationField>,
            ReportWithResultImpl<CswSourceConfigurationField>>
        prioritizedExecutor =
    ...
    if (result.isPresent()) {
      ...
      return new ReportWithResultImpl<CswSourceConfigurationField>()
          .addArgumentMessage(unknownEndpointError(hostField.path()));
    }
  }

  public ReportWithResultImpl<CswSourceConfigurationField> getCswConfigFromUrl(
  ...
  private ReportWithResultImpl<CswSourceConfigurationField> getCswConfigFromResponse(
    ...
    ReportWithResultImpl<CswSourceConfigurationField> configResult = new ReportWithResultImpl<>();
