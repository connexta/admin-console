...
public abstract class BaseFieldProvider extends BaseObjectField implements FieldProvider {
  ...
  public List<Field> getFields() {
    List<FunctionField> mutations =
        getMutationFunctions() == null ? new ArrayList() : getMutationFunctions();
    List<Field> discoveryFields =
        getDiscoveryFields() == null ? new ArrayList() : getDiscoveryFields();
  ...
  public void bindField(Field field) {
    ServiceCommons.updateGraphQLSchema(
        getClass(), String.format(BINDING_FUNCTION, fieldTypeName()));
  }

  public void unbindField(Field field) {
    ServiceCommons.updateGraphQLSchema(
        getClass(), String.format(UNBINDING_FUNCTION, fieldTypeName()));
  }
}
