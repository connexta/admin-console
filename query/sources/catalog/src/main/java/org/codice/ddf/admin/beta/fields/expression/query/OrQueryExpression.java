...
public class OrQueryExpression extends ListFieldImpl<AttributeExpression> implements FieldOperand {

    public OrQueryExpression(List<MetacardType> types) {
        super("or", new AttributeExpression(types));
    }
