...
public class SampleAction extends GetAction<Report> {
    ...
    public ReportField process() {
        Message SUCCESS_SAMPLE_MSG_1 = new SuccessMessageField("PASS", "First success message");
        Message SUCCESS_SAMPLE_MSG_2 = new SuccessMessageField("PASS_2", "Second success message");

        Message WARNING_SAMPLE_MSG_1 = new WarningMessageField("WARN", "First warning message");
        Message WARNING_SAMPLE_MSG_2 = new WarningMessageField("WARN_2", "Second warning message");

        Message FAILURE_SAMPLE_MSG_1 = new FailureMessageField("FAIL", "First fail message");
        Message FAILURE_SAMPLE_MSG_2 = new FailureMessageField("FAIL_2", "Second fail message");
