...
public class OpenSearchSourceUtils {
   ...
   * @return a {@link ReportWithResultImpl} containing the discovered {@link
   *     OpenSearchSourceConfigurationField} on success, or containing {@link
  ...
  public ReportWithResultImpl<OpenSearchSourceConfigurationField> getOpenSearchConfigFromHost(
    ...
    PrioritizedBatchExecutor<
            ReportWithResultImpl<OpenSearchSourceConfigurationField>,
            ReportWithResultImpl<OpenSearchSourceConfigurationField>>
        prioritizedExecutor =
    ...
    if (result.isPresent()) {
      ...
      return new ReportWithResultImpl<OpenSearchSourceConfigurationField>()
   ...
   * @return a {@link ReportWithResultImpl} containing the {@link
   *     OpenSearchSourceConfigurationField} or containing {@link
   *     org.codice.ddf.admin.api.report.ErrorMessage}s on failure.
   */
  private ReportWithResultImpl<OpenSearchSourceConfigurationField> getOpenSearchConfigFromResponse(
    ...
    try {
      if ((Boolean)
        ...
        configResult.addArgumentMessage(
            unknownEndpointError(responseField.requestUrlField().path()));
      }
