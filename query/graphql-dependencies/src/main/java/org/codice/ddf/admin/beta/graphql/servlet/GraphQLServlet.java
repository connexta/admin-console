...
public abstract class GraphQLServlet extends HttpServlet implements Servlet, GraphQLMBean,
    ...
    // TODO: tbatie - 3/29/17 - (getQueryExecutionStrategy -> [getQueryExecutionStrategy, getMutationExecutionStrategy].
    // TODO: tbatie - 3/29/17 - Allowed specification of which execution strategy should be used for query and mutation. The private method of query always passed null as the mutation strategy, resulting in SimpleExecutionStrategy instead of the custom ExecutionStrategy implementation
    ...
    // TODO: tbatie - 3/29/17 - Changed from private to protected for customization of errors
    protected Map<String, Object> createResultFromDataAndErrors(Object data, List<GraphQLError> errors) {
