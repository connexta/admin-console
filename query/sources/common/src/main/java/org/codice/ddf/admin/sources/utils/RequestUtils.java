...
public class RequestUtils {
   ...
   * @return {@link ReportWithResultImpl} containing a {@link ResponseField}, or containing an
   *     {@link org.codice.ddf.admin.api.report.ErrorMessage}
   */
  public ReportWithResultImpl<ResponseField> sendGetRequest(
   ...
   */
  public ReportWithResultImpl<ResponseField> sendGetRequest(
      WebClient webClient, UrlField urlField) {
   ...
   * @return a {@link ReportWithResultImpl} containing a {@link ResponseField} or an {@link
   *     org.codice.ddf.admin.api.report.ErrorMessage} on failure.
   */
  public ReportWithResultImpl<ResponseField> sendPostRequest(
   ...
   * @return a {@link ReportImpl} containing no messages on success, or containing {@link
