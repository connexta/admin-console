...
public class GraphQlHelper {
    ...
    public GraphQlHelper(Class resourceClass, String queryResourcePath, String mutationResourcePath,
    ...
    public class GraphQLRequest {
        ...
        public GraphQLRequest(String queryResourcePath, String mutationResourcePath,
                String graphQlEndpoint) {
            this.queryResourcePath = queryResourcePath;
            this.mutationResourcePath = mutationResourcePath;
            this.graphQlEndpoint = graphQlEndpoint;
