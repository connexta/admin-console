...
public interface ObjectField extends DataType<Map<String, Object>> {
  ...
  /**
   * Sets all {@link Field}s in this {@code ObjectField}. When {@code false}, all {@link Field}s and
   * this {@code ObjectField}'s requirements should be set {@code false}. Similarly for {@code
   * true}.
   *
