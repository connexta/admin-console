...
public class StsServiceProperties {
    ...
    public List<String> getConfiguredStsClaims(AdminOpFactory adminOpFactory) {
        Map<String, Object> stsConfig = adminOpFactory.read(STS_CLAIMS_CONFIGURATION_CONFIG_ID);
