...
public class ArtifactSizeEnforcerRuleTest {
  ...
  private static final String SAMPLE_ARTIFACT_FILE_NAME =
      SAMPLE_ARTIFACT_ID + "-" + SAMPLE_VERSION + ".jar";
  ...
  public void specifiedArtifactExists() throws IOException {
    ...
    ArtifactSizeEnforcerRule enforcer =
        new ArtifactSizeEnforcerRule().setArtifactLocation(sampleArtifactPath);
    try {
  ...
  public void specifiedArtifactDoesNotExist() throws EnforcerRuleException {
    ArtifactSizeEnforcerRule enforcer =
        new ArtifactSizeEnforcerRule().setArtifactLocation("ArtifactDoesNotExist.jar");
    enforcer.execute(defaultMockhelper);
  }
