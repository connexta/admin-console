    ...
    try {
      InMemoryListenerConfig ldapConfig =
          InMemoryListenerConfig.createLDAPConfig(
              ...
              null,
              getLdapPort(),
              object.getServerSSLContext().getSocketFactory());
      InMemoryListenerConfig ldapsConfig =
          InMemoryListenerConfig.createLDAPSConfig(
              "ldaps", getLdapSecurePort(), object.getServerSSLContext().getServerSocketFactory());
  ...
  SSLContext getServerSSLContext() {
    try {
      ...
      KeyStoreKeyManager keyManager =
          new KeyStoreKeyManager(keystore, keyStorePassword, "JKS", getHostname());
