...
public class GraphQLTransformScalar {
  ...
  private static final Coercing HIDDEN_COERCING =
      new Coercing() {
        @Override
  ...
  public GraphQLScalarType resolveScalarType(ScalarField field) {
    ...
    switch (field.scalarType()) {
      case INTEGER:
        type =
            field.fieldTypeName() == null
                ? Scalars.GraphQLInt
                : new GraphQLScalarType(
                    field.fieldTypeName(), field.description(), Scalars.GraphQLInt.getCoercing());
        break;
      ...
      case FLOAT:
        type =
            field.fieldTypeName() == null
                ...
                : new GraphQLScalarType(
                    field.fieldTypeName(), field.description(), Scalars.GraphQLFloat.getCoercing());
        break;
      case HIDDEN_STRING:
        type =
            field.fieldTypeName() == null
                ? Scalars.GraphQLString
                : new GraphQLScalarType(
                    field.fieldTypeName(), field.description(), HIDDEN_COERCING);
    }
