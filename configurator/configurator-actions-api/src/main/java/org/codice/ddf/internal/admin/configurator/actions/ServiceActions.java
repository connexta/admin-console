...
public interface ServiceActions {
    /**
     * Creates a handler for persisting changes to a service configuration.
     *
     * @param serviceId        the serviceId of the bundle configuration to be updated
     ...
     */
    Operation<Void> build(String serviceId, Map<String, Object> configs, boolean keepIfNotPresent)
            throws ConfiguratorException;

    /**
     * Gets the current key:value pairs set in the given configuration file.
     *
     * @param serviceId the configId of the bundle configuration file to query
     * @return the current set of key:value pairs
     * @throws ConfiguratorException if an error occurs reading state
     */
    Map<String, Object> read(String serviceId) throws ConfiguratorException;
}
