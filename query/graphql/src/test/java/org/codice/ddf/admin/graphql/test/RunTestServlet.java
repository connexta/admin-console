...
/**
 * This class will bind the field provider to the graphql servlet and run a server to host the schema. The schema can be found at http://localhost:8994/schema.json.
 * To navigate the schema more easily, use a graphql schema navigator such as graphiql. This will help validate queries and create readable documentation.
 */
