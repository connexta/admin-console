...
class ListFieldImplTest extends Specification {
    ...
    def 'test the path of fields in listfields are the listfields path + their own'() {
        ...
        listField.getList().get(0).path() == [LIST_FIELD_NAME, Field.INDEX_DELIMETER + 0, StringField.DEFAULT_FIELD_NAME]
    }
    ...
    def 'test the path of ObjectFields and their inner fields in listfields'() {
        ...
        objectFieldPath == [parentPath, Field.INDEX_DELIMETER + 0, TestObjectField.DEFAULT_FIELD_NAME].flatten()
